"use strict";(self["webpackChunkfantzulin"]=self["webpackChunkfantzulin"]||[]).push([[712],{93712:function(e,t,n){n.r(t),n.d(t,{default:function(){return gp}});var i=n(66252),s=n(49963),r=n(3577);const o={class:"div-box"},a=(0,i._)("h5",null,"To Do List",-1),c={key:0},l=["onClick"],h=(0,i._)("i",{class:"fas fa-edit"},null,-1),u=[h],d=["id","onClick"],p=(0,i._)("i",{class:"fas fa-trash-alt"},null,-1),f=[p],_={key:0},m=(0,i._)("i",{class:"fas fa-trash-alt"},null,-1),g={class:"text-left"},v=(0,i._)("p",null,"Vue.js - 使用 v-model 指令取得 input 的內容，使用 v-on:keyup.ente 事件執行 function。",-1),y=(0,i.Uk)("簡易資料庫 - 使用 "),w=(0,i.Uk)("Firebase"),I=(0,i.Uk)(" 的 Realtime Database 來即時讀寫資料。");function C(e,t,n,h,p,C){const b=(0,i.up)("el-input"),T=(0,i.up)("el-divider"),k=(0,i.up)("el-button"),E=(0,i.up)("el-link");return(0,i.wg)(),(0,i.iD)("div",o,[a,(0,i.Wm)(b,{modelValue:p.inputValue,"onUpdate:modelValue":t[0]||(t[0]=e=>p.inputValue=e),placeholder:"輸入一項待辦事項",onKeyup:t[1]||(t[1]=(0,s.D2)((e=>C.addTodo()),["enter"]))},null,8,["modelValue"]),(0,i.Wm)(T),(0,i._)("ul",null,[((0,i.wg)(!0),(0,i.iD)(i.HY,null,(0,i.Ko)(p.todos,((e,t,n)=>((0,i.wg)(),(0,i.iD)("li",{key:n},[e.isEdit?(0,i.kq)("",!0):((0,i.wg)(),(0,i.iD)("span",c,(0,r.zw)(e.text),1)),e.isEdit?((0,i.wg)(),(0,i.j4)(b,{key:1,modelValue:e.text,"onUpdate:modelValue":t=>e.text=t,onKeyup:(0,s.D2)((t=>C.updateTodo(t,e)),["enter"])},null,8,["modelValue","onUpdate:modelValue","onKeyup"])):(0,i.kq)("",!0),e.isEdit?(0,i.kq)("",!0):((0,i.wg)(),(0,i.iD)("button",{key:2,type:"button",onClick:t=>C.editTodo(e)},u,8,l)),e.isEdit?(0,i.kq)("",!0):((0,i.wg)(),(0,i.iD)("button",{key:3,type:"button",id:n,onClick:t=>C.removeTodo(e,n)},f,8,d))])))),128))]),(0,i.Wm)(T),0!=p.todos.length?((0,i.wg)(),(0,i.iD)("div",_,[(0,i.Uk)(" Total : "+(0,r.zw)(p.todos.length)+" todo ",1),(0,i.Wm)(k,{onClick:C.clearAll,type:"danger"},{default:(0,i.w5)((()=>[m])),_:1},8,["onClick"])])):(0,i.kq)("",!0),(0,i._)("div",g,[v,(0,i._)("p",null,[y,(0,i.Wm)(E,{type:"primary",href:"https://firebase.google.com/",target:"_blank",rel:"nofollow"},{default:(0,i.w5)((()=>[w])),_:1}),I])])])}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hp(e=kt()){const t=yt(e,"auth");return t.isInitialized()?t.getImmediate():Rl(e,{popupRedirectResolver:tp,persistence:[Yu,Cu,Tu]})}lp("Browser");const up={apiKey:"AIzaSyB900FNxKYIwpFvlFcs4SqZro8bHPiqxvs",authDomain:"fantzulin-e590c.firebaseapp.com",databaseURL:"https://fantzulin-e590c-default-rtdb.firebaseio.com",projectId:"fantzulin-e590c",storageBucket:"fantzulin-e590c.appspot.com",messagingSenderId:"937701848678",appId:"1:937701848678:web:d30e705555247cb5b11fa7",measurementId:"G-C1JLS7P3PL"},dp=Tt(up),pp=hp();pu(pp,"fanchi0917@gmail.com","dby123").then((e=>{const t=e.user;console.log(`user: ${t}`)})).catch((e=>{e.code;const t=e.message;console.log(`error: ${t}`)}));var fp={data(){const e=Xc(dl(dp));return sl(Zc(e,"/food")).then((e=>{if(e.exists())for(var t in e.val())this.todos.push(e.val()[t]);else console.log("No data available")})).catch((e=>{console.error(e)})),{todos:[],inputValue:"",editValue:""}},components:{},methods:{addTodo(){let e=this.inputValue;if(!e)return;const t=dl(dp),n=el(Zc(Xc(t),"/food")).key;let i={uuid:n,text:e,isEdit:!1};this.todos.push(i),nl(Xc(t,"food/"+n),i),this.inputValue=""},removeTodo(e,t){let n=e.uuid;this.todos.splice(t,1);const i=dl(dp);tl(Xc(i,"food/"+n))},editTodo(e){e.isEdit=!0},clearAll(){this.todos=[];const e=dl(dp);nl(Xc(e,"/food"),"")},updateTodo(e,t){e.target.value&&(t.text=e.target.value),t.isEdit=!t.isEdit;let n=t.uuid,i={uuid:t.uuid,text:t.text,isEdit:t.isEdit};const s=dl(dp);il(Xc(s,"food/"+n),i)}}},_p=n(83744);const mp=(0,_p.Z)(fp,[["render",C]]);var gp=mp}}]);
//# sourceMappingURL=712.e8d335bc.js.map